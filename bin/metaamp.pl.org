...
my $t0 = Benchmark->new;
my $template = "$dbdir/silva.nr_v123.fasta";
my $taxonomy = "$dbdir/silva.nr_v123.tax";
my $gold = "$dbdir/gold.fa";
...
$cmd = "$mothur \"\#classify.seqs(fasta=$analysisname.OTUs.fasta,template=$template,taxonomy=$taxonomy,method=wang,ksize=8, iters=100, cutoff=60, processors=$cpus)\"  ";
runcmds($cpus, $cmd);

######################generate alpha and beta diversity################
$cmd = "$bin/get_diversity.pl -l $analysisname.list -g $analysisname.groups -t $cpus ";
runcmds($cpus, $cmd);
...
sub merging{
    ...
    foreach (@excludes){
	msg("******Sample $_: no reads passing QC_merging, exclude it from furthur analysis\n");
	delete($mapHash->{$_});
    }
...
sub trim_techSeq_addBarcodelabel{
    ...
    foreach (@excludes){
	msg("******Sample $_: no reads passing QC primer matching stage, exclude it from furthur analysis\n");
	delete($mapHash->{$_});
    }
...
sub qcFilter{
    ...
    foreach (@excludes){
	msg("******Sample $_: no reads passing QCFilter, exclude it from furthur analysis\n");
	delete $mapHash->{$_};
    }
    #return $mapHash;
...
sub get_taxon_info{
    ...
    open(WANG, "$analysisname.OTUs.nr_v123.wang.taxonomy") or die "Could not open $analysisname.OTUs.nr_v123.wang.taxonomy to read, $!\n";
    open(MWANG, ">$analysisname.OTUs.nr_v123.mwang.taxonomy") or die "Could not open $analysisname.OTUs.nr_v123.mwang.taxonomy to write, $!\n";
    open(MWANGNR, ">$analysisname.OTUs.nr_v123.mwang.norank.taxonomy") or die "Could not open $analysisname.OTUs.nr_v123.mwang.norank.taxonomy to write, $!\n";
    while(<WANG>){
	my ($id, $tax) = $_ =~ /^(\S+?)\s+(\S.*)$/;
	my $new_tax = "";
...
######################get analysis otu table and taxonomy summary table################
    $cmd = "$bin/getOTUTaxonTable.pl -i1 $analysisname.OTUs.nr_v123.mwang.norank.taxonomy  -i2 $analysisname.shared > $analysisname.OTU-table.taxonomy";
    runcmds($cpus, $cmd);

######################get analysis otu table and taxonomy summary table################
    $cmd = "$bin/getTaxonSummary.pl -i1 $analysisname.OTUs.nr_v123.mwang.norank.taxonomy  -i2 $analysisname.shared > $analysisname.taxonomy.norank.summary";
    runcmds($cpus, $cmd);


######################get analysis otu table and taxonomy summary table without rank ################
    $cmd = "$bin/getTaxonSummary.pl -i1 $analysisname.OTUs.nr_v123.mwang.taxonomy  -i2 $analysisname.shared > $analysisname.taxonomy.summary";
    runcmds($cpus, $cmd);
}
...
RESULTS_OTUS
    ...
    <li>OTU taxonomic assignment <a href="OTU_and_taxonomy/$analysis.OTUs.nr_v123.mwang.taxonomy" title="The consensus taxonomy of each OTU" target="vis">with</a> and <a href="OTU_and_taxonomy/$analysis.OTUs.nr_v123.mwang.norank.taxonomy" title="The consensus taxonomy of each OTU without rank information" target="vis">without</a> rank</li>
...
sub print_web_alpha_diversity{
    ...
    $cmd .= "$bin/visPCoA.pl -a alpha_and_beta_diversity/$analysis.braycurtis.$dissimilarity.subsample.lt.pcoa.axes -l alpha_and_beta_diversity/$analysis.braycurtis.$dissimilarity.subsample.lt.pcoa.loadings -t $projDir/template/pcoa.html> html/$analysis.braycurtis.$dissimilarity.subsample.lt.pcoa.html;";
    $cmd .= "$bin/visPCoA.pl -a alpha_and_beta_diversity/$analysis.jclass.$dissimilarity.subsample.lt.pcoa.axes -l alpha_and_beta_diversity/$analysis.jclass.$dissimilarity.subsample.lt.pcoa.loadings -t $projDir/template/pcoa.html> html/$analysis.jclass.$dissimilarity.subsample.lt.pcoa.html;";
    $cmd .= "$bin/visPCoA.pl -a alpha_and_beta_diversity/$analysis.jest.$dissimilarity.subsample.lt.pcoa.axes -l alpha_and_beta_diversity/$analysis.jest.$dissimilarity.subsample.lt.pcoa.loadings -t $projDir/template/pcoa.html> html/$analysis.jest.$dissimilarity.subsample.lt.pcoa.html;";
    $cmd .= "$bin/visPCoA.pl -a alpha_and_beta_diversity/$analysis.thetayc.$dissimilarity.subsample.lt.pcoa.axes -l alpha_and_beta_diversity/$analysis.thetayc.$dissimilarity.subsample.lt.pcoa.loadings -t $projDir/template/pcoa.html> html/$analysis.thetayc.$dissimilarity.subsample.lt.pcoa.html;";
    ...
    $cmd .= "$bin/visNMDs.pl -s alpha_and_beta_diversity/$analysis.jest.$dissimilarity.lt.nmds.stress -a alpha_and_beta_diversity/$analysis.jest.$dissimilarity.lt.axes -t $projDir/template/nmds.html> html/$analysis.jest.$dissimilarity.lt.nmds.html;";
    ...
    $cmd .= "$bin/visNMDs.pl -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.jest.$dissimilarity.lt.nmds.stress -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.jest.$dissimilarity.lt.axes -t $projDir/template/nmds.html> html/$analysis.$dissimilarity.subsample.jest.$dissimilarity.lt.nmds.html;";
    ...
    $cmd = "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr -s alpha_and_beta_diversity/$analysis.shared -c 0.6 -p 0.05 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr.p05.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr -s alpha_and_beta_diversity/$analysis.shared -c 0.6 -p 0.01 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr.p01.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr -s alpha_and_beta_diversity/$analysis.shared -c 0.6 -p 0.05 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr.p05.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr -s alpha_and_beta_diversity/$analysis.shared -c 0.6 -p 0.01 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr.p01.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr -s alpha_and_beta_diversity/$analysis.shared -c 0.6 -p 0.05 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr.p05.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr -s alpha_and_beta_diversity/$analysis.shared -c 0.6 -p 0.01 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr.p01.gexf;";


    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.shared -c 0.6 -p 0.05 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr.p05.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.shared -c 0.6 -p 0.01 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr.p01.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.shared -c 0.6 -p 0.05 -oa 0.05 >  alpha_and_beta_diversity$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr.p05.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.shared -c 0.6 -p 0.01 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr.p01.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.shared -c 0.6 -p 0.05 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr.p05.gexf;";
    $cmd .= "$bin/make_gexf.pl -a alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr -s alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.shared -c 0.6 -p 0.01 -oa 0.05 >  alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr.p01.gexf;";
    ...
    <p class="thick">» &beta;-diversity measurements: OTU association &nbsp;&nbsp; <input TYPE="button" id="otuasso" class="btn" value="HELP" onClick="help('otuassoModal', 'otuasso', 'closeOTUasso');"></p>
     <div id="otuassoModal" class="modal">
        ...
        <p>OTU.association uses a shared or relabund file to create a matrix of correlation values indicating the association between different OTUs. Just remember that association is not the same as causation :). When we generate the gexf file, we only considered the OTUs whose aboundcne is greater than 5%, the correlation cofficient must be greater than 0.6 or less than -0.6. The gexf file can be visualized by Gephi visualization software.</p>
        </div>
        </div>
    ...
    <div id="left_col">
    <ul id="lfile">
    <li>Spearman <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr" target="vis">OTU correlation coefficient</a></li>
    <li>Spearman gexf files at <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr.p05.gexf" target="vis">0.05</a> and <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.spearman.otu.corr.p01.gexf" target="vis">0.01</a> p-value cutoff</a></li>
    <li>Pearson <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr" target="vis">OTU correlation coefficient</a></li>
    <li>Pearson gexf files at <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr.p05.gexf" target="vis">0.05</a> and <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.pearson.otu.corr.p01.gexf" target="vis">0.01</a> p-value cutoff</a></li>

    <li>Kendall <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr" target="vis">OTU correlation coefficient</a></li>
    <li>Kendall gexf files at <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr.p05.gexf" target="vis">0.05</a> and <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.kendall.otu.corr.p01.gexf" target="vis">0.01</a> p-value cutoff</a></li>
    </ul>
    </div>
    <div id="right_col">
     <ul id="lfile">
    <li>Spearman <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr" target="vis">OTU correlation coefficient</a></li>
    <li>Spearman gexf files at <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr.p05.gexf" target="vis">0.05</a> and <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.spearman.otu.corr.p01.gexf" target="vis">0.01</a> p-value cutoff</a></li>
    <li>Pearson <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr" target="vis">OTU correlation coefficient</a></li>
    <li>Pearson gexf files at <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr.p05.gexf" target="vis">0.05</a> and <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.pearson.otu.corr.p01.gexf" target="vis">0.01</a> p-value cutoff</a></li>
    <li>Kendall <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr" target="vis">OTU correlation coefficient</a></li>
    <li>Kendall gexf files at <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr.p05.gexf" target="vis">0.05</a> and <a href="alpha_and_beta_diversity/$analysis.$dissimilarity.subsample.$dissimilarity.kendall.otu.corr.p01.gexf" target="vis">0.01</a> p-value cutoff</a></li>
    </ul>
