...
BEGIN {
    ...
    $ENV{METAAMPHOME} = "/export/data/web/metaamp";
    $ENV{PERL5LIB} = "/usr/local/share/perl5/lib/perl5:";
...
my $truncqual = $query->param("truncqual");
...
# child
    ...
    my $cmd = "metaamp.pl -map $upload_mapping_file -an $analysis -seqtype $seqtype -seqformat $seqformat -minoverlen $minoverlen -maxdiffs $maxdiffs -trunclen $trunclen -maxee $maxee -oligos oligos.txt -pdiffs $pdiffs -email $email >& debug.txt";
...
sub print_job_received_html {
  print "<html>\n<head>\n";
  print "<link rel=stylesheet type=\"text/css\" href=\"http://ebg.ucalgary.ca/metaamp/css/metaamp.css\"/>\n";
  print "<title>MetaAmp job received</title>\n</head>\n";

  print "<body>\n";
  print " <div id=\"outform\">\n";
  print "  <div class=\"logo\"></div>\n";
  print "  <h1>MetaAmp Version 1.1 </h1>\n";
  ...
  #print "<p>Data files submitted:<br>\n";
  #print "<table>\n";
  #print "<tr>\n<th>Sequence files</th>\n</tr>\n";

  #for my $i (0..$#seqfiles) {
   #   print "<tr>\n";
    #  print "<td><a href=\"../tmp/$machine_time-$analysis/$seqfiles[$i]\">$seqfiles[$i]</a></td></tr>\n";
  #}
  #print "</table></p>\n";

  print "<div class=\"bottom\"></div>\n";
  print "<div class=\"sep\"></div>\n";
 print "<div class=\"foot\">Problems? Questions? Suggestions? Please contact <a href=\"mailto:xdong\@ucalgary.ca\">Xiaoli Dong</a> or <a HREF=\"mailto:mstrous\@ucalgary.ca\">Marc Strous</a></div>\n";
